 ...
 * on 2013-11-28 at 17:13:24 UTC 
 * Modify at your own risk.
 */

package com.narp.endpoints.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://narpbackend.appspot.com/_ah/api/";
  ...
  public class GetUser extends UserendpointRequest<com.narp.endpoints.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.narp.endpoints.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link com.narp.endpoints.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.narp.endpoints.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.narp.endpoints.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.narp.endpoints.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.narp.endpoints.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.narp.endpoints.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.narp.endpoints.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.narp.endpoints.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.narp.endpoints.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.narp.endpoints.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.narp.endpoints.userendpoint.model.User.class);
    }
