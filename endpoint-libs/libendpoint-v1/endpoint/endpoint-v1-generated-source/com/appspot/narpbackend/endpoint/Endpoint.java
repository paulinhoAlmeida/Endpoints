 ...
 * on 2013-11-26 at 07:36:30 UTC 
 * Modify at your own risk.
 */

package com.appspot.narpbackend.endpoint;
...
public class Endpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.16.0-rc of the endpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "endpoint/v1/hellogreeting/";
   ...
   * <pre>
   *   {@code Endpoint endpoint = new Endpoint(...);}
   *   {@code Endpoint.Greetings.List request = endpoint.greetings().list(parameters ...)}
   * </pre>
   *
  ...
  public class Greetings {
     ...
     *
     * This request holds the parameters needed by the the endpoint server.  After setting any optional
    ...
    public class GetGreeting extends EndpointRequest<com.appspot.narpbackend.endpoint.model.HelloGreeting> {
      ...
      protected GetGreeting(java.lang.Integer id) {
        super(Endpoint.this, "GET", REST_PATH, null, com.appspot.narpbackend.endpoint.model.HelloGreeting.class);
     ...
     *
     * @param times
     * @param content the {@link com.appspot.narpbackend.endpoint.model.HelloGreeting}
     * @return the request
     */
    public Multiply multiply(java.lang.Integer times, com.appspot.narpbackend.endpoint.model.HelloGreeting content) throws java.io.IOException {
      Multiply result = new Multiply(times, content);
      initialize(result);
      return result;
    }

    public class Multiply extends EndpointRequest<com.appspot.narpbackend.endpoint.model.HelloGreeting> {

      private static final String REST_PATH = "{times}";
       ...
       * @since 1.13
       */
      protected Multiply(java.lang.Integer times, com.appspot.narpbackend.endpoint.model.HelloGreeting content) {
        super(Endpoint.this, "POST", REST_PATH, content, com.appspot.narpbackend.endpoint.model.HelloGreeting.class);
